...
interface SheetContentProps
  ...
  /** When false, omits the corner X (e.g. action sheets dismissed by overlay tap). */
  showClose?: boolean
  /** Opt-in overlay material (e.g. APP_MATERIAL_OVERLAY_BACKDROP_CLASS). Defaults unchanged. */
