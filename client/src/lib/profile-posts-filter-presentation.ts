...
/** Active underline sits on the label span (label-width) — approved interactive blue. */
export const PROFILE_POSTS_FILTER_TAB_ACTIVE_CLASS =
  "font-semibold text-foreground after:absolute after:inset-x-0 after:bottom-0 after:h-[2px] after:rounded-full after:bg-[#0a83ff]" as const;
