      ...
      <div className="app-page-top-pad px-6 pb-8">
        <div className="max-w-md mx-auto">
          ...
          <div className="space-y-3">
            ...
            {verifiedArtist ? (
              <VerifiedArtistToolsSettingsRow enabled={verifiedArtist} />
            ) : null}
                  ...
                  <div className="pt-3 space-y-2 border-t border-amber-400/20">
                    ...
                    <div className="pt-2 space-y-2 border-t border-amber-400/20">
                      ...
                      {(() => {
                        ...
                        // Prefer live GET query; fall back to last successful refresh body only.
                        ...
                        return (
                          ...
                          >
                            ...
                            {/*
                              FUTURE (parked): Show "Next free release available"
                              using the earliest ledger expiry date from a server endpoint.
                              Do not estimate this client-side from release cards.
                            */}
